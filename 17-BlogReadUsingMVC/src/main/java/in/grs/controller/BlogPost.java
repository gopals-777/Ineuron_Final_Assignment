...
import in.grs.service.BlogServiceImpl;
import in.grs.service.IBlogService;
...
public class BlogPost extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		List<BlogpostModel> allBlogposts = service.getAllBlogposts();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BlogpostModel post=new BlogpostModel(title,description,content);
